...
import { updateNavAndSidebars, renderPost, openPostModal, closePostModal } from './ui.js';
import { handlePostSubmit, handleLike, handleStar, handleReplyClick, clearReply, togglePostMenu, handleDeletePost, handleRecFollow, handleUpdateSettings, handleCtrlEnter } from './event-handlers.js';
...
// --- ルーター ---
// アプリケーションの中心的な画面遷移を管理
async function router() {
    updateNavAndSidebars(); // 常にナビゲーションを最新の状態に保つ
    ...
    try {
        ...
        else await showMainScreen(); // デフォルトはホーム画面
    } catch (error) { 
