window.addEventListener('DOMContentLoaded', () => {
    ...
    const ICONS = {
      ...
      mask: `<svg viewBox="0 0 10 10" fill="none" stroke="#000000" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="5" r="4"/><line x1="5" y1="2.5" x2="5" y2="6.5"/><line x1="5" y1="7.6" x2="5" y2="7.6"/></svg>`,
    };
    ...
    async function renderPost(post, author, options = {}) {
        ...
        authorLink.insertAdjacentHTML('beforeend', await MakeTrustLabel(displayAuthor.id));
